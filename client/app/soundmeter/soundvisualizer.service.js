...
angular.module('flockingInsightsApp')
  .service('VisualizerSample', function () {
...
// Interesting parameters to tweak!
    ...
    function VisualizerSample() {
      ...
      loadSounds(this, {
        buffer: '../assets/music/TheChosenRoadie.mp3'
      });
...
// Toggle playback
    ...
    VisualizerSample.prototype.draw = function() {
      ...
      var canvas = document.querySelector('#special');
      ...
      for (var i = 0; i < this.analyser.frequencyBinCount; i++) {
        ...
        var fill = 'hsl(' + percent*100 + ', 100%, 50%)'
        drawContext.fillStyle = fill;
        drawContext.fillRect(i * barWidth, offset, barWidth, height);
        var data = 'value: '+ value + '| percent %' + (percent*100) + '| offset:' + offset + '| hue: ' + hue + '| i: ' + i;
      }
    ...
    VisualizerSample.prototype.getSampleData = function(){
